...
<title>Cloudflare Pages 部署实战指南 — 从开发到上线避坑全攻略</title>
<style>
  :root {
    --bg: #0f1117;
    --bg-card: #1a1d29;
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .hero h1 { font-size: clamp(1.8rem, 4vw, 2.8rem); font-weight: 800; line-height: 1.3; }
  .hero .subtitle { color: var(--text-muted); font-size: 1.1rem; margin-top: 12px; }
  .hero .badge { display: inline-block; background: var(--accent); color: #fff; font-size: 0.75rem; font-weight: 600; padding: 4px 12px; border-radius: 20px; margin-bottom: 16px; }
  ...
  h3 { font-size: 1.2rem; font-weight: 600; margin-top: 32px; margin-bottom: 12px; color: var(--text); }
  ...
  .pitfall-title { font-weight: 700; color: var(--red); display: flex; align-items: center; gap: 8px; }
  .pitfall-title::before { content: "⚠"; font-size: 1.2em; }
  .tip {
  ...
  .tip-title { font-weight: 700; color: var(--green); display: flex; align-items: center; gap: 8px; }
  .tip-title::before { content: "✓"; font-size: 1.2em; }
  ...
  .tag { display: inline-block; font-size: 0.7rem; font-weight: 600; padding: 2px 8px; border-radius: 4px; margin-left: 6px; }
